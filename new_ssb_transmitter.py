...
class new_ssb_transmitter(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "new_ssb_transmitter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("new_ssb_transmitter")
        ...
        self.settings = Qt.QSettings("GNU Radio", "new_ssb_transmitter")
        ...
        self.band_pass_filter_0_0 = filter.fir_filter_ccc(
            ...
            firdes.complex_band_pass(
                1,
                192000,
                variable_qtgui_range_3,
                variable_qtgui_range_4,
                100,
                firdes.WIN_HAMMING,
                6.76))
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_0 = analog.sig_source_c(192000, analog.GR_SIN_WAVE, variable_qtgui_range_2, variable_qtgui_range_0_0, 0, 0)
    ...
    def set_variable_qtgui_range_4(self, variable_qtgui_range_4):
        ...
        self.band_pass_filter_0_0.set_taps(firdes.complex_band_pass(1, 192000, self.variable_qtgui_range_3, self.variable_qtgui_range_4, 100, firdes.WIN_HAMMING, 6.76))
    ...
    def set_variable_qtgui_range_2(self, variable_qtgui_range_2):
        ...
        self.analog_sig_source_x_0.set_frequency(self.variable_qtgui_range_2)
...
def main(top_block_cls=new_ssb_transmitter, options=None):
