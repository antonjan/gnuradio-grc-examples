...
class hackrf_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "hack rf test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("hack rf test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_test")
...
def main(top_block_cls=hackrf_test, options=None):
