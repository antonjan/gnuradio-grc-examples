...
# Title: DVB-S2 B200 Transmitter
# Generated: Fri Aug 18 16:55:54 2017
##################################################
...
class dvbs2_8psk_tx_var_v1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._center_freq_options = (50e6, 437e6, 1280e6, 10400e6, )
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 3,0,6,5)
        self.fft_filter_xxx_0_0 = filter.fft_filter_ccc(1, (firdes.root_raised_cosine(1.0, samp_rate, samp_rate/2, rolloff, taps)), 1)
        ...
        self.dtv_dvbs2_physical_cc_0 = dtv.dvbs2_physical_cc(dtv.FECFRAME_NORMAL, dtv.C9_10, dtv.MOD_8PSK, dtv.PILOTS_OFF, 0)
        self.dtv_dvbs2_modulator_bc_0_0 = dtv.dvbs2_modulator_bc(dtv.FECFRAME_NORMAL,
        dtv.C9_10, dtv.MOD_8PSK, dtv.INTERPOLATION_OFF)
        self.dtv_dvbs2_interleaver_bb_0 = dtv.dvbs2_interleaver_bb(dtv.FECFRAME_NORMAL, dtv.C9_10, dtv.MOD_8PSK)
        ...
        self.dtv_dvb_bbheader_bb_0 = dtv.dvb_bbheader_bb(dtv.STANDARD_DVBS2, dtv.FECFRAME_NORMAL, dtv.C9_10, dtv.RO_0_35, dtv.INPUTMODE_NORMAL, dtv.INBAND_OFF, 168, 4000000)
	fifo_path = os.path.dirname(os.path.realpath(__file__)) + '/fifo.ts'
	self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, fifo_path, True)
        ...
        self.connect((self.dtv_dvbs2_interleaver_bb_0, 0), (self.dtv_dvbs2_modulator_bc_0_0, 0))
        self.connect((self.dtv_dvbs2_modulator_bc_0_0, 0), (self.dtv_dvbs2_physical_cc_0, 0))
        self.connect((self.dtv_dvbs2_physical_cc_0, 0), (self.fft_filter_xxx_0_0, 0))
        self.connect((self.fft_filter_xxx_0_0, 0), (self.qtgui_freq_sink_x_0_0, 0))
        self.connect((self.fft_filter_xxx_0_0, 0), (self.uhd_usrp_sink_0_0_0, 0))
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.uhd_usrp_sink_0_0_0.set_gain(self.tx_gain, 0)
    ...
    def set_taps(self, taps):
        self.taps = taps
        self.fft_filter_xxx_0_0.set_taps((firdes.root_raised_cosine(1.0, self.samp_rate, self.samp_rate/2, self.rolloff, self.taps)))
...
def main(top_block_cls=dvbs2_8psk_tx_var_v1, options=None):
    ...
    rate_help = 'Viterbi rate. 1/2, 2/3, 3/4, 5/6, 7/8 9/10 (default).'
    parser.add_argument('-vr', '--viterbi-rate', dest='rate', default='9/10',
