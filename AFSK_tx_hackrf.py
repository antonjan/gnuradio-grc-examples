...
class AFSK_tx_hackrf(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "afsk tx with hackrf")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("afsk tx with hackrf")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AFSK_tx_hackrf")
        ...
        # Variables
        ##################################################
        self.variable_qtgui_range_0 = variable_qtgui_range_0 = 435080481
        self.samp_rate = samp_rate = 2.4e6

        ##################################################
        # Blocks
        ##################################################
        self._variable_qtgui_range_0_range = Range(435070000, 435090000, 0.1, 435080481, 200)
        ...
        self.audio_source_0 = audio.source(48000, 'plughw:1,1,1', True)
...
def main(top_block_cls=AFSK_tx_hackrf, options=None):
